...
export function AlarmSection() {
  ...
  const data = {
    install: [
      { name: 'Базовая сигнализация', price: 'от 2 500 ₽', note: 'Без автозапуска', features: ['Охранный комплекс', 'Датчик удара', 'Сирена', 'Пульты 2 шт.'], highlight: false },
      { name: 'С автозапуском', price: 'от 6 500 ₽', note: 'Starline A93 и аналоги', features: ['Автозапуск по таймеру', 'Прогрев двигателя', 'Управление со смартфона', 'Гарантия 1 год'], highlight: true },
      { name: 'GSM сигнализация', price: 'от 9 000 ₽', note: 'Полный контроль онлайн', features: ['GPS-трекер', 'Уведомления на телефон', 'Блокировка двигателя', 'Приложение 24/7'], highlight: false },
    ],
    remove: [
    ...
    diag: [
      ...
      { name: 'Полная диагностика', price: 'от 1 200 ₽', note: 'Поиск неисправностей', features: ['Диагностика всех каналов', 'Проверка автозапуска', 'Письменный отчёт'], highlight: true },
      { name: 'Настройка и обновление', price: 'от 800 ₽', note: 'Перепрошивка и настройка', features: ['Обновление прошивки', 'Настройка датчиков', 'Обучение брелков'], highlight: false },
    ],
  };
...
export function ArmorSection() {
  ...
  const data = {
    lights: [
      { name: 'Передние фары', price: 'от 3 500 ₽', note: 'Антигравийная плёнка', features: ['Полное покрытие фар', 'Защита от камней', 'Прозрачный глянец'], highlight: false },
      { name: 'Передние + задние', price: 'от 5 500 ₽', note: 'Все 4 оптики', features: ['Комплектное покрытие', 'Толщина 200 мкм', 'Гарантия 3 года'], highlight: true },
      { name: 'Туманки + ПТФ', price: 'от 1 500 ₽', note: 'Противотуманные фонари', features: ['Полное покрытие', 'Без пожелтения', 'Самовосстановление'], highlight: false },
    ],
    zones: [
      { name: 'Пороги + арки', price: 'от 4 000 ₽', note: 'Самые уязвимые места', features: ['Матовая или глянцевая плёнка', 'Толщина 300 мкм', 'Стойкость к гравию'], highlight: false },
      { name: 'Капот + бампер', price: 'от 7 000 ₽', note: 'Ударная зона', features: ['Антигравий на капот', 'Передний бампер', 'Самовосстановление царапин'], highlight: true },
      { name: 'Полный пакет зон риска', price: 'от 12 000 ₽', note: 'Все уязвимые зоны', features: ['Капот + бампер + арки + пороги', 'Зеркала', 'Гарантия 5 лет'], highlight: false },
    ],
    body: [
      { name: 'Кузов — матовая плёнка', price: 'от 45 000 ₽', note: 'Полное матовое покрытие', features: ['Смена цвета', 'Защита лакокрасочного', 'Гарантия 5 лет'], highlight: false },
      { name: 'Кузов — глянцевая плёнка', price: 'от 38 000 ₽', note: 'Защита заводского цвета', features: ['Сохранение оттенка', 'Антигравий по всему кузову', 'Самовосстановление'], highlight: true },
      { name: 'Кузов — PPF (полиуретан)', price: 'от 65 000 ₽', note: 'Максимальная защита', features: ['Военный полиуретан', 'Защита от глубоких царапин', 'Гарантия 7 лет'], highlight: false },
    ],
  };
